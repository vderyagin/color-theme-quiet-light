...
(let ((class '((class color) (background light) (min-colors 256)))
  ...
  (custom-theme-set-faces
   ...
   `(org-block-begin-line ((,class (:inherit font-lock-comment-delimiter-face))))
   `(org-meta-line ((,class (:inherit font-lock-comment-delimiter-face))))
   ...
   `(bmkp-no-local ((,class (:inherit bmkp-non-file))))
   ...
   `(helm-source-header ((,class (:inherit font-lock-function-name-face :weight bold))))
   ...
   `(ledger-font-periodic-xact-face ((,class (:inherit font-lock-string-face))))
